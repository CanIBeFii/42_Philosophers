...
/*   Updated: 2023/02/06 14:52:40 by fialexan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_message(int message_type, long long int time, int philo_number)
{
	if (message_type == FORK_CODE)
		printf("[%lld] %d %s", time, philo_number, FORK_MESSAGE);
	else if (message_type == EAT_CODE)
		printf("[%lld] %d %s", time, philo_number, EAT_MESSAGE);
	else if (message_type == SLEEP_CODE)
		printf("[%lld] %d %s", time, philo_number, SLEEP_MESSAGE);
	else if (message_type == THINK_CODE)
		printf("[%lld] %d %s", time, philo_number, THINK_MESSAGE);
	else if (message_type == DIED_CODE)
		printf("[%lld] %d %s", time, philo_number, DIED_MESSAGE);
	else
